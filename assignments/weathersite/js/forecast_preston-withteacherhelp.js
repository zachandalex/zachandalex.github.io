...
if(mytown == 'Preston') {
    parameters = 'id=5604473';
}
else if(mytown == 'Soda Springs') {
    parameters = 'id=5607916';
}
else if(mytown == 'Fish Haven') {
    parameters = 'zip=83287,us';
}

let forecastRequest = new XMLHttpRequest();
let apiURLstring2 = "https://api.openweathermap.org/data/2.5/forecast?" + parameters + "&units=imperial&APPID=833948fa196c1bccd74cedfe6acf348c";
...
forecastRequest.onload = function () {
    ...
    for (i = 0; i < jlist.length; i++) {
        if (jlist[i].dt_txt.includes("18:00:00")) {
            ...
            var mydate = new Date(weatherData.list[i].dt_txt);
            var daysOfWeek = ['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'];
            day.push(daysOfWeek[mydate.getDay()]);
    ...
    document.getElementById("image1").setAttribute("src", "https://openweathermap.org/img/w/"+img01+".png");
    ...
    document.getElementById("image2").setAttribute("src", "https://openweathermap.org/img/w/" + img02 + ".png");
    ...
    document.getElementById("image3").setAttribute("src", "https://openweathermap.org/img/w/" + img03 + ".png");
    ...
    document.getElementById("image4").setAttribute("src", "https://openweathermap.org/img/w/" + img04 + ".png");
    ...
    document.getElementById("image5").setAttribute("src", "https://openweathermap.org/img/w/" + img05 + ".png");
